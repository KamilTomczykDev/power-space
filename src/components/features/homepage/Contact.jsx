      ...
      <div className="relative flex flex-col items-center gap-6 p-4 lg:gap-10">
        ...
        <div className="z-[5] flex items-center">
          <img
            ...
            src={contactImg}
          />
          <div className="flex max-w-[400px] flex-col items-center gap-6 rounded-md border-2 border-stone-700 p-2 sm:p-6">
            {/* form */}
            ...
            <form className="flex w-full flex-col gap-2">
              ...
              <textarea
                rows="7"
                placeholder="Message"
                className="w-full resize-none bg-stone-800 p-2 text-white"
              />
